...
#        Getting rid of axes ticks
        ...
        f.savefig('plots/birthday_panel.pdf')
...
#    generating random array
    ...
    print(f'Size: {r}')
    pp = panelPlotter(5000, axes_lines=True, cmap='Set1')
    pp.panel_plot()

    plt.show()
    
#    Saving to plots dir -- os.path this
    file_name = os.path.join('..', 'plots', 'mom_proofs', f'mom_proof_Reds_{r}_{pp.cmap}.pdf')
    print(f'Saving to filepath: {file_name}')
    pp.f_panel.savefig(file_name)
