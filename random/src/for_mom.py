...
class forMom:
    ...
    def __init__(self, array_size, cmap='Set1', axes_lines:bool=False):
        ...
        The 4 panels should contain one of each 
        '''
    ...
    def hist2d(self, savefig=False):
        ...
        if savefig:
            ...
            file_path = os.path.join("..", "plots", "mom_proofs",
                                     f"mom_hist2d_{self.cmap}_{self.array_size}.pdf")
            f.savefig(file_path)
    ...
    def triplot(self, savefig:bool=False):
        ...
        if savefig:
            ...
            f.savefig(os.path.join("..", "plots",
                                  "mom_proofs", f"triplot_{self.cmap}_{index}_mom_proof.pdf"))
